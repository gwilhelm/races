...
var USER_OR_GROUP_NAME = 'gwilhelm'; // TODO: Insert GitHub username or group name.
...
////////////////////////////////////////////////////////////////////////////////
app.put('/races/:id',      // TODO: change to suit your URI design.
  function(req, res) {
    ...
    // See the form in `views/list-races.ejs`.
    var item = req.body.item;
    
    item.type = 'race'; // TODO: change to the type of item you want
...
////////////////////////////////////////////////////////////////////////////////
app.get('/races/',         // TODO: change to suit your URI design. 
  function(req, res) {

    var item_type = 'race'; // TODO: change to the type of item you want.
    ...
    db.getAll(item_type, function(err, items) {
      ...
      // Otherwise, use the returned data to render an HTML page.
        ...
        res.render(
          'list-races',   // TODO: change to the name of your HTML template.
          { items: items }
        );
      }
    });
...
////////////////////////////////////////////////////////////////////////////////
app.post('/runners/', // TODO: change to suit your URI design.
  function(req, res) {
  
    // Get the item info that was POSTed from the input form.
    // See the form in `views/one-runner.ejs`.
    var item = req.body.item;

    item.type = 'runner'; // TODO: change to the type of item you want
...
////////////////////////////////////////////////////////////////////////////////
app.put('/runners/:id', // TODO: change to suit your URI design.
  function(req, res) {
...
////////////////////////////////////////////////////////////////////////////////
app.get('/runners/',          // TODO: change to suit your URI design. 
  function(req, res) {

    var item_type = 'runner'; // TODO: change to the type of item you want.
    ...
    db.getSome(item_type, req.query, function(err, items) {
      ...
      // Otherwise, use the returned data to render an HTML page.
        ...
        res.render(
          'list-runners', // TODO: change to the name of your HTML template.
          { items: items }
        );
      }
    });
...
////////////////////////////////////////////////////////////////////////////////
app.get('/races/:id',      // TODO: change to suit your URI design.
  function(req, res) {
    ...
    db.getOne(item_type, item_id, function(err, item) {
      ...
      // Otherwise, get the related items associated with this item.
        ...
        var related_type = 'runner'; // TODO: change to type of related item.

        // Set our query to find the items related to the requested item.
        req.query.race = item_id; // TODO: change `party` to reflect the
        ...
        db.getSome(related_type, req.query, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
            'one-race', // TODO: change to the name of your HTML template.
...
////////////////////////////////////////////////////////////////////////////////
app.get('/runners/:id',       // TODO: change to suit your URI design.
  function(req, res) {
    ...
    db.getOne(item_type, item_id, function(err, item) {
      ...
      // Otherwise, get the items potentially related to this item.
        ...
        var related_type = 'race'; // TODO: change to type of related item.
        ...
        db.getAll(related_type, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
              'one-runner', // TODO: change to name of your HTML template.
              { item: item, related_items: items }
            );
          }
        });
